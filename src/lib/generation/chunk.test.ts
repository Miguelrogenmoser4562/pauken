...
import { capTokens, chunkByTokens, chunkByTokensWithOffsets, estimateTokens } from "./chunk";
...
describe("chunk utilities", () => {
  ...
  it("chunkByTokensWithOffsets tracks character positions", () => {
    const text = "Hello world.\n\nGoodbye world.\n\n".repeat(10);
    const chunks = chunkByTokensWithOffsets(text, 50);
  ...
  it("single chunk covers full input", () => {
    const text = "short text";
    const chunks = chunkByTokensWithOffsets(text, 1000);
